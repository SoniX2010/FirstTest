...
class Human:
    ...
    def eat(self):
        ...
        def clean_home(self):
            ...
            car_indexes = f"{self.car.brand} car
            indexes
            "
    ...
    def is_alive(self):
        ...
        class Auto:
            def __init__(self, brand_list):
                self.brand = random.choice(list
                                           (brand_list))

            self.fuel = brand_list[self.brand]
            ["fuel"]
            self.strength = brand_list[self.brand]
            ["strength"]
            self.consumption =
            brand_list[self.brand]["consumption"]
